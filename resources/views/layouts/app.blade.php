...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link collapsed" href="/detailpenjualan" aria-expanded="true"
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="/pelanggan" aria-expanded="true" aria-controls="collapseUtilities">
